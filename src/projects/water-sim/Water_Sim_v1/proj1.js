...
function renderfalingcube(){
    renderfalingcube = !renderfalingcube;
}
...
function updateSliderx(sliderAmount) {
    var value = sliderAmount*0.01;
    //$("#Xrotate").html(value.toFixed(1));
    x = value;
}

function updateSlidery(sliderAmount) {
    var value = sliderAmount*0.01;
    //$("#Yrotate").html(value.toFixed(1));
    y = value;
}
